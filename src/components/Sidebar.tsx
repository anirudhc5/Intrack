...
import { LayoutDashboard, Globe, BarChart3, Settings, Search, LogOut, User } from 'lucide-react';
    ...
    <aside className="fixed left-0 top-0 w-64 h-full bg-white border-r border-[#c3c6d7]/30 flex flex-col">
      <div className="p-6">
        <div className="flex items-center gap-3 mb-8">
          <Image src="/logo.svg" alt="Intrack Logo" width={32} height={32} />
          <div>
            <h1 className="text-xl font-semibold text-[#131b2e]">Intrack</h1>
        ...
        <div className="mb-4">
          <p className="text-xs font-semibold text-[#737686] mb-3 px-3 uppercase tracking-wider">Pipelines</p>
      ...
      <div className="mt-auto p-4 border-t border-[#c3c6d7]/30">
        <div className="flex items-center gap-3 mb-4 px-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-[#131b2e] truncate">{user?.email}</p>
          </div>
        </div>
        <button
